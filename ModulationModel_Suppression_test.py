# -*- coding: utf-8 -*-
"""
Created on Mon Sep 19 10:54:51 2022
...
model = DeepQNetwork(q_input_size,
                     ...
                     q_num_layer,
                     q_output_size)
model = torch.load("{}/StimuModel_Suppression_H32_2_2.2".format(opt.saved_path), map_location=lambda storage, loc: storage)
model = model.eval()
...
scio.savemat('GeneratedData\Data_Suppression_H32_2_2.2.mat', {'Time':Time,
